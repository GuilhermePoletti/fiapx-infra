...
echo " Acompanhe o status dos containers executando: kubectl get pods -n fiapx"
echo " O Swagger da API unificada estará disponível (via Minikube IP) na porta 30081."
echo " O Minikube IP pode ser descoberto rodando: minikube ip"
echo "====================================================================="
